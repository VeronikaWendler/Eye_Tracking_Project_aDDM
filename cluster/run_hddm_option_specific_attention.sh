#!/bin/bash
#SBATCH --job-name=addm_att_ES
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=6
#SBATCH --mem=180G
#SBATCH --output=logs/addm_att_ES_%j.out
#SBATCH --error=logs/addm_att_ES_%j.err
...
INPUT_HOST="${INPUT_HOST:-${OUT_DIR_HOST}/models/model_input_ES_option_specific_attention.csv}"
...
echo "========================================================================"
echo "ES OPTION-SPECIFIC ATTENTION aDDM"
echo "========================================================================"
echo "IMAGE=${IMAGE}"
...
echo "BURN=${BURN}"
echo ""
echo "The model directory is mounted at /target_models so saved HDDM objects"
echo "retain a stable database path for later diagnostics."
echo "========================================================================"
...
apptainer exec --cleanenv \
  ...
  "${IMAGE}" \
  python /workspace/addm_fit_option_specific_attention.py \
    --data /out/models/model_input_ES_option_specific_attention.csv \
...
echo "Finished ES option-specific-attention aDDM."
