...
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/smoke/es_identity_S_upper_basic_z_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/smoke/es_identity_S_upper_basic_z_%j.err
...
MODEL_DIR_HOST="$OUT_ROOT/models/es_identity_S_upper_basic_z_smoke"
CHAINS="${CHAINS:-1}"
SAMPLES="${SAMPLES:-100}"
BURN="${BURN:-20}"
...
echo "============================================================================"
echo "STUDY 1 ES S-UPPER / E-LOWER BASIC aDDM SMOKE"
...
echo "Finished STUDY 1 es_identity_S_upper_basic_z smoke."
