...
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/smoke/es_identity_S_upper_basic_noz_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/smoke/es_identity_S_upper_basic_noz_%j.err
...
echo "Finished STUDY 1 es_identity_S_upper_basic_noz smoke."
