#!/bin/bash
#SBATCH --job-name=s1_contrast_noz
#SBATCH --time=02:00:00
#SBATCH --cpus-per-task=2
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/smoke/es_identity_S_upper_contrast_noz_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/smoke/es_identity_S_upper_contrast_noz_%j.err
...
echo "============================================================================"
echo "STUDY 1 ES S-UPPER / E-LOWER CONTRAST aDDM SMOKE"
...
echo "Finished STUDY 1 es_identity_S_upper_contrast_noz smoke."
