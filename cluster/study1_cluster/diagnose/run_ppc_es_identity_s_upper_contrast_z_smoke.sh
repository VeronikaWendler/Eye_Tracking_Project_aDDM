#!/bin/bash
#SBATCH --job-name=s1_ppc_cz_sm
#SBATCH --time=01:00:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=32G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/es_identity_s_upper_contrast_z_smoke_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/es_identity_s_upper_contrast_z_smoke_%j.err
...
echo "========================================================================"
echo "STUDY1 S-UPPER CONTRAST Z PPC SMOKE"
echo "========================================================================"
...
echo "Finished study1 es_identity_s_upper_contrast_z smoke PPC."
