...
#SBATCH --mem=32G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/s1_ppc_cz_sm_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/s1_ppc_cz_sm_%j.err
...
MODEL_DIR="${OUT_ROOT}/models/es_identity_S_upper_contrast_z_final"
PPC_DIR="${OUT_ROOT}/ppc/es_identity_s_upper_contrast_z_smoke"
...
echo "Finished study1 PPC smoke."
