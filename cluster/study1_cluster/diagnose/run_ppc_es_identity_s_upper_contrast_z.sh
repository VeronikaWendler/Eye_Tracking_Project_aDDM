...
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/s1_ppc_cz_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/s1_ppc_cz_%j.err
...
PPC_DIR="${OUT_ROOT}/ppc/es_identity_s_upper_contrast_z_main"
...
echo "======================================================================"
echo "STUDY1 S-UPPER CONTRAST+Z PPC (main)"
