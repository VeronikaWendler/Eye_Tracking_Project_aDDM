#!/bin/bash
#SBATCH --job-name=s1_ppc_cz
#SBATCH --time=08:00:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/es_identity_s_upper_contrast_z_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/es_identity_s_upper_contrast_z_%j.err
...
echo "========================================================================"
echo "STUDY1 S-UPPER CONTRAST Z PPC FULL"
echo "========================================================================"
...
echo "Finished study1 es_identity_s_upper_contrast_z full PPC."
