#!/bin/bash
#SBATCH --job-name=s1_basic_noz
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=6
#SBATCH --mem=180G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/final/es_identity_S_upper_basic_noz_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study1_aDDM/derivatives/logs/final/es_identity_S_upper_basic_noz_%j.err
...
echo "Finished STUDY 1 es_identity_S_upper_basic_noz final."
