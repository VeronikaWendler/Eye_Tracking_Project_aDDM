...
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/smoke/es_identity_S_upper_contrast_z_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/smoke/es_identity_S_upper_contrast_z_%j.err
...
echo "Finished STUDY 2 es_identity_S_upper_contrast_z smoke."
