#!/bin/bash
#SBATCH --job-name=s2_contrast_noz
#SBATCH --time=02:00:00
#SBATCH --cpus-per-task=2
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/smoke/es_identity_S_upper_contrast_noz_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/smoke/es_identity_S_upper_contrast_noz_%j.err
...
MODEL_DIR_HOST="$OUT_ROOT/models/es_identity_S_upper_contrast_noz_smoke"
CHAINS="${CHAINS:-1}"
SAMPLES="${SAMPLES:-100}"
BURN="${BURN:-20}"
...
echo "============================================================================"
echo "STUDY 2 ES S-UPPER / E-LOWER CONTRAST aDDM SMOKE"
...
echo "Finished STUDY 2 es_identity_S_upper_contrast_noz smoke."
