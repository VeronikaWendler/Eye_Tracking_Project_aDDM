...
#SBATCH --mem=32G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/s2_ppc_cnoz_sm_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/s2_ppc_cnoz_sm_%j.err
...
PPC_DIR="${OUT_ROOT}/ppc/es_identity_s_upper_contrast_noz_smoke"
