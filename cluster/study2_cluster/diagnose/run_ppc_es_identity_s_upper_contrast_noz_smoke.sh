#!/bin/bash
#SBATCH --job-name=s2_ppc_cnoz_sm
#SBATCH --time=01:00:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=32G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/es_identity_s_upper_contrast_noz_smoke_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/es_identity_s_upper_contrast_noz_smoke_%j.err
...
PPC_DIR_HOST="${STUDY_ROOT}/derivatives/ppc/es_identity_s_upper_contrast_noz_smoke"
...
echo "========================================================================"
echo "STUDY2 S-UPPER CONTRAST NO-Z PPC SMOKE"
echo "========================================================================"
...
echo "Finished study2 es_identity_s_upper_contrast_noz smoke PPC."
