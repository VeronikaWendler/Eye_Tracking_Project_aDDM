#!/bin/bash
#SBATCH --job-name=s2_ppc_talk
#SBATCH --time=00:30:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=16G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/ppc_talk_ready_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/ppc_talk_ready_%j.err
...
apptainer exec --cleanenv \
  ...
  python /workspace/py_diagnose/replot_ppc_talk_ready.py \
    --study study2 --ppc-dir /ppc --out-dir /ppc/figures/talk_ready
echo "Finished Study 2 talk-ready PPC replot."
