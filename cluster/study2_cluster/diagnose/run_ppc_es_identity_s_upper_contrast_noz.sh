...
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/es_identity_s_upper_contrast_noz_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/es_identity_s_upper_contrast_noz_%j.err
...
echo "========================================================================"
echo "STUDY2 S-UPPER CONTRAST NO-Z PPC FULL"
echo "========================================================================"
...
echo "Finished study2 es_identity_s_upper_contrast_noz full PPC."
