#!/bin/bash
#SBATCH --job-name=s2_esaddm_talkplots
#SBATCH --time=01:00:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/esaddm_contrast_z_talkplots_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/esaddm_contrast_z_talkplots_%j.err
...
echo "=============================================================================="
echo "STUDY 2 TALK-READY ESaDDM PLOTS"
...
echo "=============================================================================="
echo "FINISHED STUDY 2 TALK-READY ESaDDM PLOTS"
