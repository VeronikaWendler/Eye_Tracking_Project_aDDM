#!/bin/bash
#SBATCH --job-name=s2_rec_cz
#SBATCH --array=0-9%3
#SBATCH --time=08:00:00
#SBATCH --cpus-per-task=3
#SBATCH --mem=96G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/recovery/es_identity_s_upper_contrast_z_main_%A_%a.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/recovery/es_identity_s_upper_contrast_z_main_%A_%a.err
...
echo "=============================================================================="
echo "study2 parameter recovery: es identity s upper contrast z"
...
echo "finished study2 recovery rep ${SLURM_ARRAY_TASK_ID}"
