#!/bin/bash
#SBATCH --job-name=s2_contrast_z
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=6
#SBATCH --mem=180G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/es_identity_S_upper_contrast_z_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/es_identity_S_upper_contrast_z_%j.err
...
echo "============================================================================"
echo "STUDY 2 ES S-UPPER / E-LOWER CONTRAST aDDM FULL FIT"
...
echo "Finished STUDY 2 es_identity_S_upper_contrast_z final."
