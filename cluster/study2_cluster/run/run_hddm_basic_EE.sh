#!/bin/bash
#SBATCH --job-name=s2_basic_EE
#SBATCH --time=04:00:00
#SBATCH --cpus-per-task=3
#SBATCH --mem=128G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/basic_EE_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/basic_EE_%j.err
...
PHASE="EE"
MODEL_SUBDIR="basic_EE"
MODEL_NAME="basic_aDDM_EE"
