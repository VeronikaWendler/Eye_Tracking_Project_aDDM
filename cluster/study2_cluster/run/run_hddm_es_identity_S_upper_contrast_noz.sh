...
#SBATCH --mem=180G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/es_identity_S_upper_contrast_noz_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/es_identity_S_upper_contrast_noz_%j.err
...
echo "Finished STUDY 2 es_identity_S_upper_contrast_noz final."
