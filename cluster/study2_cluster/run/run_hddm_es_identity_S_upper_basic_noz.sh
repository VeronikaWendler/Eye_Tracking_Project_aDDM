...
#SBATCH --mem=180G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/es_identity_S_upper_basic_noz_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/es_identity_S_upper_basic_noz_%j.err
...
echo "============================================================================"
echo "STUDY 2 ES S-UPPER / E-LOWER BASIC aDDM FULL FIT"
...
echo "Finished STUDY 2 es_identity_S_upper_basic_noz final."
