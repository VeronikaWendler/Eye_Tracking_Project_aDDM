#!/bin/bash
#SBATCH --job-name=s2_es_id_joint
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=6
#SBATCH --mem=180G
#SBATCH --output=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/es_identity_S_upper_joint_%j.out
#SBATCH --error=/rds/projects/z/zhanglp-vwendler-core/Study2_aDDM/derivatives/logs/final/es_identity_S_upper_joint_%j.err
...
echo "========================================================================"
echo "STUDY 2 ES S-UPPER IDENTITY JOINT E/S CONTRAST aDDM"
echo "S = UPPER / E = LOWER | TIES RETAINED"
echo "========================================================================"
...
echo "Finished Study 2 S-upper identity joint E/S contrast aDDM."
